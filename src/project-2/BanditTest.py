...
thompson_policy = thomson_bandit.ThomsonBandit(n_actions, n_outcomes, 1, 1)
...
results = pandas.DataFrame({'Thompson': thompson_result, 'Linear': average_result})
